...
%\usepackage{enumitem}  % 加這行，讓清單支援進階設定
...
%
% margins setting
\geometry{verbose,a4paper,tmargin=3cm,bmargin=3cm,lmargin=3cm,rmargin=3cm,footskip=2cm}
%
...
% 1. 設定章節標題大小 (Chapter=18pt, Section=14pt, Subsection=12pt)
\ctexset{
    chapter = {
        format = \centering\bfseries\fontsize{18}{24}\selectfont,
        beforeskip = 1em,
        afterskip = 3em,
        fixskip = true,
    },
    section = {
        format = \bfseries\fontsize{14}{20}\selectfont, % 這裡就是你要的 14pt
        beforeskip = 0.2em,
        afterskip = 0.2em,
    },
    subsection = {
        format = \bfseries\fontsize{14}{20}\selectfont, % 這裡設為 12pt (粗體)
        beforeskip = 0.2em,
        afterskip = 0.2em,
    }
}
