...
\makebox[1.5cm][s]{\textbf{\large{摘要}}}\\
\end{center}
% Resume the line spacing to the desired setting
\renewcommand{\baselinestretch}{\mybaselinestretch}   %恢復原設定
%it needs a font size changing command to be effective
...
% Acknowledgment
\newpage
\chapter*{\protect\makebox[1cm][s]{\large{\nameAckn}}} %\makebox{} is fragile; need protect
...
\newpage
\renewcommand{\contentsname}{\protect\makebox[1cm][s]{\nameToc}}
{ 
...
\renewcommand{\listtablename}{\protect\makebox[1.5cm][s]{\nameLot}}
{ \let\bfseries\mdseries 
  \listoftables 
}
%\makebox{} is fragile; need protect
...
\renewcommand{\listfigurename}{\protect\makebox[1.5cm][s]{\nameTof}}
{ \let\bfseries\mdseries 
  \listoffigures
}
%\makebox{} is fragile; need protect
